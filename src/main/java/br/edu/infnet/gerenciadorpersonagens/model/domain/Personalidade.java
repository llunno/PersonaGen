...
public class Personalidade extends Caracteristica{
    ...
    public String formatTelaCadastroPersonagem() {
        return "<strong>Palavra Definição</strong>: " + palavraDefinicao + ".<br>"
                ...
                + "<strong>Qualidades</strong>: " + Utils.concatenarExibicaoLista(qualidades) + ".<br>"
                + "<strong>Defeitos</strong>: " + Utils.concatenarExibicaoLista(defeitos) + ".<br>"
                + "<strong>Interesses</strong>: " + Utils.concatenarExibicaoLista(interesses) + ".<br>"
                + "<strong>Desinteresses</strong>: " + Utils.concatenarExibicaoLista(desinteresses) + ".<br>"
